...
# Đọc dữ liệu từ file CSV
data_path = 'C:/Users/ADMIN/Documents/HocMay/Student-Final-Grade-ML/data/split/train_data.csv'
data = pd.read_csv(data_path)

# Thiết lập K-Fold trên training set
kf = KFold(n_splits=10, shuffle=True, random_state=42)

# Lưu từng fold vào các tệp CSV trong đường dẫn K-folds2
output_folder = 'C:/Users/ADMIN/Documents/HocMay/Student-Final-Grade-ML/data/split/K-folds2'

for fold, (train_index, val_index) in enumerate(kf.split(data)):
    fold_train_data = data.iloc[train_index].reset_index(drop=True)  # Gộp cả X và y
    fold_val_data = data.iloc[val_index].reset_index(drop=True)      # Gộp cả X và y

    # Lưu từng fold vào file CSV
    fold_train_data.to_csv(f'C:/Users/ADMIN/Documents/HocMay/Student-Final-Grade-ML/data/split/K-folds2/fold_{fold}_train.csv', index=False)
    fold_val_data.to_csv(f'C:/Users/ADMIN/Documents/HocMay/Student-Final-Grade-ML/data/split/K-folds2/fold_{fold}_val.csv', index=False)
