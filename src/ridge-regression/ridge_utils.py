...
def load_fold_data(fold_number):
    ...
    train_data = pd.read_csv(f'D:/Project_ML/Student-Final-Grade-ML/data/split/K-folds/fold_{fold_number}_train.csv')
    val_data = pd.read_csv(f'D:/Project_ML/Student-Final-Grade-ML/data/split/K-folds/fold_{fold_number}_val.csv')
