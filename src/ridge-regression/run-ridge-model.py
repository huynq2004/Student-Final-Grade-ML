...
X_train, y_train = utils.load_data_from('D:/Project_ML/Student-Final-Grade-ML/data/split/K-folds/fold_1_train.csv')
...
plot.plot_final_scores_comparison('D:/Project_ML/Student-Final-Grade-ML/data/split/test_data.csv', 'ridge_model_weights.npy')