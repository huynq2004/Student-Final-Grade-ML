...
def load_fold_data(fold_number):
    ...
    train_data = pd.read_csv(f'C:/Users/ADMIN/Documents/HocMay/Student-Final-Grade-ML/data/split/K-folds2/fold_{fold_number}_train.csv')
    val_data = pd.read_csv(f'C:/Users/ADMIN/Documents/HocMay/Student-Final-Grade-ML/data/split/K-folds2/fold_{fold_number}_val.csv')
